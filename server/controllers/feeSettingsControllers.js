...
exports.setAdmissionExamFee = catchAsyncErrors(async (req, res) => {
    ...
    const {admissionFeeMonth,examFeeMonth,libraryFeeMonth,medicineFeeMonth} = req.body;

  try {

    const fee = await Fee.findOneAndUpdate({monthSet:{admissionFeeMonth,examFeeMonth,libraryFeeMonth,medicineFeeMonth}})
